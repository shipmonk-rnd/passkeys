 ...
 * order to re-serialise a COSE key ({@see \ShipMonk\Passkeys\Cose\CoseKey::toBytes()}) and to build
 * authenticator outputs in {@see \ShipMonk\Passkeys\Testing\FakeAuthenticator}: signed integers,
